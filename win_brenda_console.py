    ...
    while True:
        ...
        if nprojconf=='y':
            ...
            if (uploadtype == 0):
                ...
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\assets\\lighting\\ALL\\')
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\assets\\lighting\\' + sequence_name, True)
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\assets\\lighting\\' + sequence_name + '\\' + shot_number)
                ...
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\fonts\\ALL\\')
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\fonts\\' + sequence_name, True)
                directories_to_zip += get_subdirectories(abs_project_path, '3D\\fonts\\' + sequence_name + '\\' + shot_number)
